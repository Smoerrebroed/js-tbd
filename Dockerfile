...
COPY --chown=tbd resources/TIB_tdv_bd_8.1.0_linux_x86_64.bin resources/tbd_server.options /tmp/
RUN chmod +x /tmp/TIB_tdv_bd_8.1.0_linux_x86_64.bin && \
  /tmp/TIB_tdv_bd_8.1.0_linux_x86_64.bin --optionfile /tmp/tbd_server.options && \
  rm /tmp/TIB_tdv_bd_8.1.0_linux_x86_64.bin /tmp/tbd_server.options
